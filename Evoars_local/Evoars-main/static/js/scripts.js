    ...
    (function initializeTranslations() {
        ...
        window.translations = {
            ...
            ar: {
                ...
                colorize_translate_btn: "تلوين وترجمة (DeepL)", subtitle_btn: "إضافة ترجمة فيديو (DeepL)", dubbing_btn: "دبلجة فيديو (DeepL)", manga_btn: "نص إلى مانجا",
                upload_image_prompt: "انقر أو اسحب لرفع الصورة (الصور)", upload_image_formats_size: "PNG, JPG أو WEBP (الحد الأقصى 10 ميجابايت)",
                remove_image_btn: "إزالة جميع الصور", remove_single_image_btn: "إزالة الصورة", remove_video_btn: "إزالة الفيديو", remove_file_btn: "إزالة الملف",
                source_language_label: "اللغة المصدر", target_language_label: "اللغة الهدف",
                auto_detect_option: "تعرف تلقائي", language_tr: "التركية", language_en: "الإنجليزية", language_fr: "الفرنسية", language_de: "الألمانية",
                language_es: "الإسبانية", language_it: "الإيطالية", language_ja: "اليابانية", language_pt: "البرتغالية", language_ru: "الروسية", language_zh: "الصينية",
                language_pl: "البولندية", language_ar: "العربية",
                upload_video_prompt: "انقر أو اسحب لرفع الفيديو", upload_video_formats_size: "MP4, MOV أو AVI (الحد الأقصى 100 ميجابايت)",
                video_tag_not_supported: "متصفحك لا يدعم تشغيل الفيديو.",
                auto_dubbing_label: "دبلجة تلقائية", manual_dubbing_label: "دبلجة يدوية", upload_srt_prompt: "رفع ملف SRT",
                upload_srt_formats_size: "SRT (الحد الأقصى 5 ميجابايت)", upload_video_for_manual_dub_prompt: "انقر لرفع الفيديو",
                manga_text_label: "نص المانجا", manga_text_placeholder: "أدخل النص لإنشاء المانجا...", submit_btn: "إرسال",
                result_title: "نتائج المعالجة", new_process_btn: "عملية جديدة", register_btn_sidebar: "إنشاء حساب", login_btn_sidebar: "تسجيل الدخول",
                purchase_btn_sidebar: "شراء رصيد", register_modal_title: "إنشاء حساب", fullname_label: "الاسم الكامل", fullname_placeholder: "اسمك الكامل",
                email_label: "البريد الإلكتروني", email_placeholder: "example@mail.com", password_label: "كلمة المرور", password_placeholder: "********",
                confirm_password_label: "تأكيد كلمة المرور", register_submit_btn: "إنشاء حساب", login_modal_title: "تسجيل الدخول",
                login_submit_btn: "تسجيل الدخول", forgot_password_link: "نسيت كلمة المرور؟", purchase_modal_title: "شراء",
                buy_credits_btn: "شراء رصيد", business_package_btn: "باقة الأعمال", api_access_btn: "الوصول عبر API",
                credit_purchase_modal_title: "شراء رصيد", credit_100_title: "100 رصيد", credit_100_desc: "الباقة الأساسية",
                credit_500_title: "500 رصيد", credit_500_desc: "الباقة القياسية", credit_1000_title: "1000 رصيد",
                credit_1000_desc: "الباقة المميزة", buy_btn: "شراء", business_package_modal_title: "باقة الأعمال",
                business_monthly_title: "الخطة الشهرية", business_monthly_feat1: "5000 رصيد/شهر", business_monthly_feat2: "أولوية في طابور المعالجة",
                business_monthly_feat3: "دعم فني 24/7", business_yearly_title: "الخطة السنوية", business_yearly_feat1: "8000 رصيد/شهر",
                business_yearly_feat2: "أولوية في طابور المعالجة", business_yearly_feat3: "دعم فني 24/7",
                business_yearly_feat4: "تدريب واستشارات مخصصة", api_access_modal_title: "الوصول عبر API", api_starter_title: "API البداية",
                api_starter_feat1: "1000 طلب API/شهر", api_starter_feat2: "وظائف أساسية", api_starter_feat3: "دعم عبر البريد الإلكتروني",
                api_pro_title: "API الاحترافي", api_pro_feat1: "10000 طلب API/شهر", api_pro_feat2: "جميع الوظائف",
                api_pro_feat3: "دعم فني 24/7", api_pro_feat4: "دعم تكامل مخصص",
                processing_text: "جاري المعالجة، يرجى الانتظار...", preview_title: "معاينة النتائج", download_btn: "تحميل",
                download_all_zip_title: "تحميل الكل كمجلد مضغوط ZIP", download_results_btn: "تحميل النتائج (.zip)", download_zip_info: "يتم تجميع الملفات في مجلد مضغوط.",
                error_processing_file: "خطأ في معالجة الملف: ", error_network: "خطأ في الشبكة أو تعذر الاتصال بالخادم.",
                error_select_process: "يرجى اختيار العملية أولاً.", preview_not_supported_for: "المعاينة غير مدعومة لـ", file_type: "نوع الملف",
        ...
        const siteSupportedLanguages = { 'ar': 'العربية', 'en': 'English', 'tr': 'Türkçe', 'es': 'Español', 'fr': 'Français', 'de': 'Deutsch', 'it': 'Italiano', 'pt': 'Português', 'ru': 'Русский', 'zh': '中文 (简体)', 'ja': '日本語', 'pl': 'Polish' };
        const formSupportedLanguages = { 'ar': 'language_ar', 'en': 'language_en', 'tr': 'language_tr', 'de': 'language_de', 'es': 'language_es', 'it': 'language_it', 'pl': 'language_pl', 'fr': 'language_fr', 'pt': 'language_pt' };
